...
fun getProductByCategory(productCategory: String ,callback: (ArrayList<ProductModel>) -> Unit) {

    val list = ArrayList<ProductModel>()
    ApiClient.getRetrofitClient().getProductByCategory(productCategory).enqueue(object : Callback<List<ProductModel>> {
